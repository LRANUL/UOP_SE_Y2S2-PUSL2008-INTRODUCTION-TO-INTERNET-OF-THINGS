...
export class EditLectureSessionModalPage implements OnInit {
  ...
  constructor(
    ...
    private editLectureSessionService: FirebaseService
  ) { }
  ...
  retrievePublishedLectureSessionStatuses = () =>
    this.editLectureSessionService.retrievePublishedLectureSessionStatuses().subscribe(response => (this.publishedLectureSessionStatuses = response));
