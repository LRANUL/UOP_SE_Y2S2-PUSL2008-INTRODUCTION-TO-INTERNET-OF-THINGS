...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _material_module__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    /*! ./material.module */
  ...
  function srcAppOfficeSettingsUpdateAccountPasswordModalUpdateAccountPasswordModalPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UpdateAccountPasswordModalPage = /*#__PURE__*/function () {
      function UpdateAccountPasswordModalPage(modalController, formBuilder, alertController, popoverController, loadingController) {
      ...
      _createClass(UpdateAccountPasswordModalPage, [{
        ...
        value: function updateAccountPassword(title, content, value) {
                  ...
                  case 0:
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        text: 'Continue',
                        handler: function handler() {
                          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this9, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
                            var loggedInUser, newAccountPassword, loading;
                            return regeneratorRuntime.wrap(function _callee6$(_context6) {
                              while (1) {
                                switch (_context6.prev = _context6.next) {
                                  case 0:
                                    console.log("Alert Box: Update Account Password Request Accepted"); // Updating account password of the currently logged in user

                                    loggedInUser = firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().currentUser;
                                    newAccountPassword = value.confirmPassword;
                                    loggedInUser.updatePassword(newAccountPassword).then(function () {
                                      ...
                                      console.log("Error: " + error); //  this.alertNotice("Error: ", "An error has occurred: " + error);
                                    }); // Loading spinner
        ...
        key: "alertNoticeHeaderOnly",
        value: function alertNoticeHeaderOnly(title) {
            ...
            return regeneratorRuntime.wrap(function _callee10$(_context10) {
              while (1) {
                switch (_context10.prev = _context10.next) {
                  ...
                  case 2:
                    moreInformationPopover = _context10.sent;
    ...
    var FirebaseService = /*#__PURE__*/function () {
      ...
      _createClass(FirebaseService, [{
        ...
        value: function registerUser(value) {
          ...
          return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(value.email, value.password).then(function (success) {
              ...
              _this10.firestore.collection('users/userTypes/studentUsers/').doc(success.user.uid).set({
                name: {
        ...
        value: function updateProgramOfficeUserActivity(accountActivity, docId) {
          ...
          return new Promise(function (resolve, reject) {
            _this11.firestore.doc("/users/userTypes/programOfficeUsers/" + docId).update({
        ...
        */
        ...
        value: function lecturerRegistrationDetails(value, loggedInUserId, loggedInUserFaculty) {
          ...
          return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(value.nsbmEmail, value.confirmPassword).then(function (success) {
              ...
              _this12.firestore.collection("users/userTypes/lecturerUsers/").doc(success.user.uid).set({
        ...
        key: "retrieveOnlineUserDetails",
        value: function retrieveOnlineUserDetails(userType) {
          return this.firestore.collection("users/userTypes/" + userType, function (ref) {
            return ref.where("accountActivity", "==", "Online");
          }).snapshotChanges();
        ...
        value: function updateProgramOfficeUser(value, docId) {
          ...
          return new Promise(function (resolve, reject) {
            _this13.firestore.doc("/users/userTypes/programOfficeUsers/" + docId).update({
              name: {
                prefix: value.prefixName,
                firstName: value.firstName,
                middleName: value.middleName,
