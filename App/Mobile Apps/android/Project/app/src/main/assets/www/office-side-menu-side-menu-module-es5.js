...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["office-side-menu-side-menu-module"], {
  ...
  function srcAppOfficeSideMenuSideMenuPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SideMenuPage = /*#__PURE__*/function () {
      function SideMenuPage(router, alertController, sideMenuService, angularFireAuth, loadingController) {
        var _this = this;
      ...
      _createClass(SideMenuPage, [{
        ...
        key: "logoutAlert",
        value: function logoutAlert(title, content) {
                  ...
                  case 0:
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        text: 'Continue',
                        handler: function handler() {
                          _this3.logoutProcessApproved(); // Updating the program office user account activity to OFFLINE
        ...
        key: "logoutProcessApproved",
        value: function logoutProcessApproved() {
                  ...
                  case 5:
                    ...
                    if (firebase__WEBPACK_IMPORTED_MODULE_6__["auth"]().currentUser) {
                      firebase__WEBPACK_IMPORTED_MODULE_6__["auth"]().signOut().then(function () {
                        ...
                        _this4.alertNotice("Error", "Logout Process Failed, " + error);
                      });
