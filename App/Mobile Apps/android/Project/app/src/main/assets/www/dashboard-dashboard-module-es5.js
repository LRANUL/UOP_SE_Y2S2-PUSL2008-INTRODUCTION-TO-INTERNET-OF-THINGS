  ...
  function srcAppOfficeDashboardDashboardPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardPage = /*#__PURE__*/function () {
      function DashboardPage(sideMenuPageUserFaculty, dashboardService, alertController, popoverController) {
        ...
        this.retrieveOnlineUserDetails = function () {
          // Retrieving user details of student users that have an account status "Online" from the firestore database
          _this.dashboardService.retrieveOnlineUserDetails("studentUsers").subscribe(function (response) {
            _this.activeStudentUsersLoadingSpinner = false;
            _this.onlineStudentUsersCount = response.length;
            _this.activeStudentUserDetailsLoadingSpinner = false;
            _this.onlineStudentUserDetails = response;
          }); // Retrieving user details of lecturer users that have an account status "Online" from the firestore database


          _this.dashboardService.retrieveOnlineUserDetails("lecturerUsers").subscribe(function (response) {
            _this.activeLecturerUsersLoadingSpinner = false;
            _this.onlineLecturerUsersCount = response.length;
            _this.activeLecturerUserDetailsLoadingSpinner = false;
            _this.onlineLecturerUserDetails = response;
          }); // Retrieving user details of program office users that have an account status "Online" from the firestore database


          _this.dashboardService.retrieveOnlineUserDetails("programOfficeUsers").subscribe(function (response) {
            _this.activeProgramOfficeUsersLoadingSpinner = false;
            _this.onlineProgramOfficeUsersCount = response.length;
            _this.activeProgramOfficeUserDetailsLoadingSpinner = false;
            _this.onlineProgramOfficeUserDetails = response;
          });
        };
        ...
        this.retrievePublishedLectureSessionsCurrentDate = function () {
          return _this.dashboardService.retrievePublishedLectureSessionsCurrentDate(_this.sideMenuPageUserFaculty.passLoggedInUserFaculty(), _this.currentDate, _this.nextDate).subscribe(function (response) {
            if (response.length > 0) {
              ...
              _this.showLoadingDotsTodaysLectureSession = false;
              _this.noLectureSessionsTodayText = true;
            }
          });
        };
        ...
        this.retrievePublishedLecturerToPONotice = function () {
          return _this.dashboardService.retrievePublishedLecturerToPONotice(_this.currentDateNotice, _this.dateThreeDaysBeforeCurrentDate).subscribe(function (response) {
            if (response.length > 0) {
              ...
              _this.showLoadingDotsLatestLecturerPONotices = false;
              _this.noLecturerPONoticeText = true;
            }
          });
      ...
      _createClass(DashboardPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.retrieveOnlineUserDetails(); // Retrieving upcoming published lecture sessions from the firestore database and assigning them to the calendar
        ...
        value: function convertToTwoDigit(numericValue) {
          if (numericValue < 10) {
        ...
        key: "calculateTotalOnlineUsers",
        value: function calculateTotalOnlineUsers(onlineStudentUsers, onlineLecturerUsers, onlineProgramOfficeUsers) {
          var totalActiveUsers = onlineStudentUsers + onlineLecturerUsers + onlineProgramOfficeUsers; // Checking if number has one or two digits
