...
let UpdateAccountPasswordModalPage = class UpdateAccountPasswordModalPage {
    constructor(modalController, formBuilder, alertController, popoverController) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.alertController = alertController;
        this.popoverController = popoverController;
